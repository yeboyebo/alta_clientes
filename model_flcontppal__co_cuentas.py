...
# @class_declaration alta_clientes_co_cuentas #
class alta_clientes_co_cuentas(interna_co_cuentas, helpers.MixinConAcciones):
    pass
...
class co_cuentas(alta_clientes_co_cuentas, helpers.MixinConAcciones):
    pass
