...
# @class_declaration alta_clientes_gruposclientes #
class alta_clientes_gruposclientes(interna_gruposclientes, helpers.MixinConAcciones):
    pass
...
class gruposclientes(alta_clientes_gruposclientes, helpers.MixinConAcciones):
    pass
