...
# @class_declaration alta_clientes_agentes #
class alta_clientes_agentes(interna_agentes, helpers.MixinConAcciones):
    pass
...
class agentes(alta_clientes_agentes, helpers.MixinConAcciones):
    pass
