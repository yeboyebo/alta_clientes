...
# @class_declaration alta_clientes_usuarios #
class alta_clientes_usuarios(interna_usuarios, helpers.MixinConAcciones):
    pass
...
class usuarios(alta_clientes_usuarios, helpers.MixinConAcciones):
    pass
