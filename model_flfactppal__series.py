...
# @class_declaration alta_clientes_series #
class alta_clientes_series(interna_series, helpers.MixinConAcciones):
    pass
...
class series(alta_clientes_series, helpers.MixinConAcciones):
    pass
