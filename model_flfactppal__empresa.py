...
# @class_declaration alta_clientes_empresa #
class alta_clientes_empresa(interna_empresa, helpers.MixinConAcciones):
    pass
...
class empresa(alta_clientes_empresa, helpers.MixinConAcciones):
    pass
